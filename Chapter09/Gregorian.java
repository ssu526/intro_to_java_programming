...
public class Gregorian{
	public static void main(String[] args){
		...
		System.out.println("Year "+gregorian.get(GregorianCalendar.YEAR));
		System.out.println("Month "+gregorian.get(GregorianCalendar.MONTH));	
		System.out.println("Day "+gregorian.get(GregorianCalendar.DAY_OF_MONTH));
